...
<body>
  ...
  <section class="section product-detail">
    <div class="details container-md">
      ...
      <div class="right">
        <span>Home/Girl's Bag</span>
        <h1>Girl’s Bag By Handsome</h1>
        <div class="price">2000 BDT</div>
        <form>
          <div>
            <select>
  ...
  <section class="section product-detail">
    <div class="details container-md">
      ...
      <div class="right">
        <span>Home/kid's Bag</span>
        <h1>Kid's Bag By Handsome</h1>
        <div class="price">1500 BDT</div>
        <form>
          <div>
            <select>
              <option value="Select Size" selected disabled>Select Size</option>
  ...
  <section class="section product-detail">
    <div class="details container-md">
      ...
      <div class="right">
        <span>Home/Boy's Shirt</span>
        <h1>Boy’s Shirt By Handsome</h1>
        <div class="price">2500 BDT</div>
        <form>
          <div>
            <select>
              <option value="Select Size" selected disabled>Select Size</option>
  ...
  <section class="section product-detail">
    <div class="details container-md">
      ...
      <div class="right">
        <span>Home/Girl's Bag</span>
        <h1>Girl’s Hand Bag By Handsome</h1>
        <div class="price">2400 BDT</div>
        <form>
          <div>
            <select>
              <option value="Select Size" selected disabled>Select Size</option>
        ...
        <h3>Product Detail</h3>
        <p>It is very good in quality.</p>
      </div>
    </div>
  </section>
  <!-- Product Details -->
  <section class="section product-detail">
    <div class="details container-md">
      ...
      <div class="right">
        <span>Home/Boy's Shoe</span>
        <h1>Boy’s Shoes By Handsome</h1>
        <div class="price">1200 BDT</div>
        <form>
          <div>
            <select>
              <option value="Select Size" selected disabled>Select Size</option>
  ...
  <section class="section product-detail">
    <div class="details container-md">
      ...
      <div class="right">
        <span>Home/Boy's Watch</span>
        <h1>Boy’s Watch By GUCCI</h1>
        <div class="price">1000 BDT</div>
        <form>
          <div>
            <select>
              <option value="Select Size" selected disabled>Select Size</option>
